        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="dashboard.php">
              ...
              <h3 class="brand-text">ADULLAM Admin</h3>
            </a>
          </li>
            ...
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100">
                  ...
                  ?>
                    <a href="view-appform?aticid=<?php echo $row['appid']; ?>">
                      <div class="media">
                        <div class="media-left align-self-center"><i class="ft-plus-square icon-bg-circle bg-cyan"></i></div>
                        <div class="media-body">
                          <h6 class="media-heading"><b><?php echo $row['FirstName']; ?></b> applied for admission</h6>
                          <small>
                            <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">at <?php echo $row['programApplieddate']; ?></time>
                          </small>
                        </div>
                      </div>
                    </a>
