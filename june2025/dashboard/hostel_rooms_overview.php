  ...
  <main class="flex-1 p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        <a href="add_hostel_room.php" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded shadow flex items-center">
          <i class="fas fa-plus mr-2"></i> Add Room
        </a>
        <a href="manual_reassign.php" class="bg-purple-700 hover:bg-purple-800 text-white font-semibold py-2 px-4 rounded shadow flex items-center">
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="py-3 px-4">
                  <div class="flex justify-center space-x-2">
                    <a href="edit_hostel_room.php?id=<?= $r['id'] ?>" 
            ...
            <?php else: ?>
              <tr>
                <td colspan="8" class="py-4 text-center text-gray-500">
                  No rooms found. <a href="add_hostel_room.php" class="text-blue-600 hover:underline">Add your first room</a>
                </td>
              </tr>
            <?php endif; ?>
          </tbody>
...
function confirmDelete(roomId) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = `delete_hostel_room.php?id=${roomId}`;
    }
  });
}
...
function toggleStatus(roomId, currentStatus, currentOccupancy) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = `toggle_room_status.php?id=${roomId}`;
        }
    });
}
