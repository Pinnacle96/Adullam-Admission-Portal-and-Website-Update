...
function generateAdmissionLetter($userId, $pdo)
{
    ...
    <body style='font-family:Arial,sans-serif;font-size:13px;line-height:1.7;color:#333;padding:40px;'>
        ...
        " program, commencing on <strong>June 26, 2025</strong>.
        </p>
        ...
        ($programCode === 'MA' ? "<li><strong>Focus Area:</strong> $maFocus</li>" : "") . "
            ...
            <li><strong>Start Date:</strong> June 26, 2025</li>
        </ul>
        <p>
        Please note that your admission is <strong>subject to the provision and documentation of your academic credentials</strong> and other required documents.<br>
            <strong>Additionally, semester fees (or at least 60% of the fees)</strong> must be paid on or before the program start date.
        </p>

        <p>
            Attached is a comprehensive guide to help you prepare for your program. Kindly review it carefully and contact us with any questions.
        </p>
