...
<div class="flex flex-col md:flex-row">
    ...
    <main class="flex-1 p-4 sm:p-6 lg:p-8 main-content">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <a href="export_hostel_pdf.php?<?= http_build_query($filters) ?>"
...
window.viewDetails = async function(id) {
    try {
        ...
        const response = await fetch(`ajax/get_registration_details.php?id=${id}`);
    ...
    window.deleteRegistration = function(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('ajax/delete_registration.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
