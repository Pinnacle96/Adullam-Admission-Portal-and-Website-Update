...
<body class="bg-gradient-to-br from-purple-50 to-gray-100 min-h-screen flex items-center justify-center px-4 py-8">
    <div class="bg-white shadow-xl rounded-2xl w-full max-w-md overflow-hidden">
        ...
        <div class="p-8">
            ...
            <!-- Login Form -->
            <form id="formLogin" method="POST" action="login.php" class="space-y-5">
                <div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="forgot_password.php" class="font-medium text-purple-600 hover:text-purple-500">Forgot password?</a>
                    </div>
                </div>
                <button type="submit"
            ...
            <!--        <a href="index.php" class="font-medium text-purple-600 hover:text-purple-500">Apply now</a>-->
            <!--    </p>-->
            <!--</div>-->
        </div>
    </div>
