...
<div id="messageModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 sm:p-6">
            <div class="relative w-full max-w-2xl transform overflow-hidden rounded-[2rem] border border-white/20 bg-white/95 text-left shadow-[0_30px_80px_rgba(15,23,42,0.35)] ring-1 ring-purple-100 transition-all opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" id="modalPanel">
                <div class="absolute inset-x-0 top-0 h-32 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.55),_transparent_40%),linear-gradient(120deg,rgba(76,29,149,0.18),rgba(126,34,206,0.08))]"></div>
                <div class="absolute right-0 top-0 pr-4 pt-4 sm:pr-5 sm:pt-5 z-10">
                    <button type="button" id="closeModalX" class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/90 text-gray-400 shadow-sm transition hover:text-gray-600 hover:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                ...
                <div class="relative px-5 pb-5 pt-8 sm:px-8 sm:pb-7 sm:pt-10">
                    <div class="w-full">
                        <div class="rounded-[1.5rem] bg-white/90 p-1">
                            <div class="rounded-[1.35rem] bg-gradient-to-r from-purple-900 to-purple-700 px-5 py-5 text-white sm:px-6">
                                <p class="text-xs font-bold uppercase tracking-[0.28em] text-purple-200">Important Update</p>
                            <?php if (!empty($modal_title)): ?>
                                <h3 class="mt-3 text-2xl sm:text-3xl font-extrabold leading-tight text-white" id="modal-title"><?= htmlspecialchars($modal_title) ?></h3>
                            <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            if (file_exists($deadlineFile)) {
                                ...
                                if (!empty($deadline)) {
                                    ...
                                    $countdownHtml .= '<div class="mb-5 rounded-[1.5rem] border border-purple-200 bg-gradient-to-r from-purple-50 to-white px-4 py-4 text-center shadow-sm sm:px-5">';
                                    $countdownHtml .= '<p class="text-xs font-bold uppercase tracking-[0.24em] text-purple-700 mb-2">';
                                    $countdownHtml .= 'Closing Date: <span class="text-purple-950">' . $formattedDate . '</span>';
                                    $countdownHtml .= '</p>';
                                    $countdownHtml .= '<div id="countdown" class="text-2xl sm:text-3xl font-black text-purple-700 font-mono tracking-tight" data-deadline="' . $deadline . '">Loading...</div>';
                                    $countdownHtml .= '</div>';
                                }
                            }
                            ...
                            <div class="prose max-w-none text-gray-600 prose-p:leading-relaxed prose-a:text-purple-700 prose-a:no-underline hover:prose-a:text-purple-900 prose-strong:text-gray-900">
                                <?= $modal_content ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border-t border-purple-100 bg-slate-50/80 px-5 py-4 sm:px-8">
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                    <?php if (!$isApplicationClosed): ?>
                    <a href="requirements" class="inline-flex w-full items-center justify-center rounded-full bg-purple-600 px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-purple-500 sm:w-auto">Apply Now</a>
                    <?php endif; ?>
                    <button type="button" id="closeModalBtn" class="inline-flex w-full items-center justify-center rounded-full bg-white px-5 py-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition hover:bg-gray-50 sm:w-auto">Close</button>
                    </div>
                </div>
            </div>
        </div>
...
<main class="bg-gradient-to-b from-white via-purple-50/40 to-white text-gray-800 font-sans">
    
    <!-- Hero Section -->
    <section id="hero-slider" class="relative min-h-screen flex items-center overflow-hidden text-white">
        <div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out hero-slide active opacity-100" style="background-image: url('assets/img/hero-carousel/1.jpg');"></div>
        <div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out hero-slide opacity-0" style="background-image: url('assets/img/hero-carousel/2.jpg');"></div>
        <div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out hero-slide opacity-0" style="background-image: url('assets/img/hero-carousel/4.jpg');"></div>
        
        <div class="absolute inset-0 z-10 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.10),_transparent_28%),linear-gradient(120deg,rgba(2,6,23,0.92),rgba(76,29,149,0.78),rgba(0,0,0,0.68))]"></div>
        <div class="absolute -top-16 right-0 z-10 h-72 w-72 rounded-full bg-purple-400/20 blur-3xl"></div>
        <div class="absolute bottom-0 left-0 z-10 h-80 w-80 rounded-full bg-fuchsia-400/10 blur-3xl"></div>
        
        <div class="relative z-20 max-w-7xl mx-auto w-full px-6 py-24 md:py-32">
            <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1.2fr)_380px] gap-10 items-center">
                <div class="text-center lg:text-left">
                    <div class="hero-text-content opacity-100 transition-all duration-700 ease-out">
                        <h2 class="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight mb-4">RCN Theological Seminary - Adullam</h2>
                        <p class="text-lg md:text-xl font-light max-w-2xl mx-auto lg:mx-0 mb-8">
                            An institution committed to raising Christ-like leaders with deep biblical roots and spiritual fire.
                        </p>
                        <a href="#programs" class="inline-flex items-center justify-center bg-purple-600 hover:bg-purple-700 text-white font-semibold px-8 py-4 rounded-full shadow-lg transition transform hover:scale-105">
                            Explore Our Programs
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:justify-self-end">
                    <div class="rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-2xl backdrop-blur-xl">
                        <div class="rounded-[1.5rem] bg-white/95 p-6 text-slate-900">
                            <a href="#about" class="flex items-center justify-between rounded-2xl bg-purple-50 px-4 py-4 transition hover:bg-purple-100">
                                <span class="font-semibold text-slate-900">A Message from the President</span>
                                <i class="fas fa-arrow-right text-purple-700"></i>
                            </a>
                            <a href="#programs" class="mt-3 flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-4 transition hover:bg-slate-100">
                                <span class="font-semibold text-slate-900">Explore Our Programs</span>
                                <i class="fas fa-arrow-right text-purple-700"></i>
                            </a>
                            <a href="#testimonials" class="mt-3 flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-4 transition hover:bg-slate-100">
                                <span class="font-semibold text-slate-900">What Our Students Say</span>
                                <i class="fas fa-arrow-right text-purple-700"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="relative z-20 mt-12 flex justify-center lg:justify-start gap-3">
                <span class="h-2.5 w-10 rounded-full bg-white/90"></span>
    ...
    <section class="relative -mt-10 md:-mt-14 z-20">
        <div class="max-w-7xl mx-auto px-6">
            <div class="rounded-[2rem] bg-gradient-to-r from-purple-800 to-purple-600 text-white p-8 md:p-10 shadow-2xl">
                <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_auto] gap-8 items-center text-center lg:text-left">
                    <div>
                        <h2 class="text-3xl md:text-4xl font-bold mb-2">Contending for the Truth</h2>
                        <p class="text-lg md:text-xl font-light">In a world of falsehood, it begins with a proper education.</p>
                    </div>
                    <div>
                        <a href="requirements" class="inline-flex items-center justify-center bg-white text-purple-700 font-semibold px-8 py-4 rounded-full shadow-xl hover:bg-gray-200 transition transform hover:scale-105">
                            Apply Now
                        </a>
                    </div>
                </div>
    ...
    <section id="about" class="py-20 md:py-24">
        <div class="max-w-7xl mx-auto px-6">
            <div class="rounded-[2rem] bg-white p-8 md:p-10 shadow-2xl shadow-purple-100/60 ring-1 ring-purple-100">
                <div class="grid grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)] gap-12 items-center">
                    <div class="flex flex-col items-center text-center">
                        <div class="rounded-[1.75rem] bg-gradient-to-br from-purple-700 to-slate-900 p-[1px] w-full max-w-xs">
                            <div class="rounded-[1.7rem] bg-white p-6">
                                <img src="assets/img/team/team 1.jpg" alt="Provost" class="w-64 h-64 rounded-full object-cover shadow-xl mx-auto mb-6">
                                <p class="text-xl italic font-serif text-gray-600">"Our Seminary stands on faithfulness to the Scriptures and deep devotion to Christ."</p>
                                <p class="text-gray-500 mt-2">- The President</p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Programs Section -->
    <section id="programs" class="py-20 md:py-24">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-purple-700">Explore Our Programs</h2>
                <p class="mt-2 text-gray-600 text-base md:text-lg">Training Christ-like leaders with deep biblical roots.</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <a href="cert" class="group rounded-[1.75rem] bg-white p-7 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 transition hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-800 group-hover:text-purple-700">Certificate in Theology</h3>
                </a>

                <a href="dip" class="group rounded-[1.75rem] bg-white p-7 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 transition hover:-translate-y-1 hover:shadow-2xl">
                    <div class="flex justify-center mb-5">
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-50">
                            <svg class="w-10 h-10 text-purple-600 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 14l9-5-9-5-9 5 9 5z" />
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-800 group-hover:text-purple-700">Diploma in Theology</h3>
                </a>

                <a href="bdiv" class="group rounded-[1.75rem] bg-white p-7 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 transition hover:-translate-y-1 hover:shadow-2xl">
                    <div class="flex justify-center mb-5">
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-50">
                            <svg class="w-10 h-10 text-purple-600 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 19V6.2C4 5.0799 4 4.51984 4.21799 4.09202C4.40973 3.71569 4.71569 3.40973 5.09202 3.21799C5.51984 3 6.0799 3 7.2 3H16.8C17.9201 3 18.4802 3 18.908 3.21799C19.2843 3.40973 19.5903 3.71569 19.782 4.09202C20 4.51984 20 5.0799 20 6.2V17H6C4.89543 17 4 17.8954 4 19ZM4 19C4 20.1046 4.89543 21 6 21H20M9 7H15M9 11H15M9 15H12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-800 group-hover:text-purple-700">Bachelor of Divinity</h3>
                </a>

                <a href="pgdt" class="group rounded-[1.75rem] bg-white p-7 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 transition hover:-translate-y-1 hover:shadow-2xl">
                    <div class="flex justify-center mb-5">
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-50">
                            <svg class="w-10 h-10 text-purple-600 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 14l9-5-9-5-9 5 9 5z" />
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-800 group-hover:text-purple-700">Postgraduate Diploma</h3>
                </a>

                <a href="masters" class="group rounded-[1.75rem] bg-white p-7 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 transition hover:-translate-y-1 hover:shadow-2xl">
                    <div class="flex justify-center mb-5">
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-50">
                            <svg class="w-10 h-10 text-purple-600 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-800 group-hover:text-purple-700">M.A Christian Apologetics</h3>
                </a>

                <a href="master" class="group rounded-[1.75rem] bg-white p-7 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 transition hover:-translate-y-1 hover:shadow-2xl">
                    <div class="flex justify-center mb-5">
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-50">
                            <svg class="w-10 h-10 text-purple-600 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-800 group-hover:text-purple-700">M.A Biblical Studies (OT/NT)</h3>
                </a>
            </div>
        </div>
    </section>
    ...
    <!-- Events & Chapel Section -->
    <section id="events-chapel" class="py-20 md:py-24">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="rounded-[2rem] bg-white p-6 md:p-8 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100">
                    <h2 class="text-3xl font-bold text-purple-800 mb-6">Seminary Events</h2>
                    <div class="swiper events-swiper rounded-[1.5rem] overflow-hidden shadow-lg">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="assets/images/Events/landscale.png" alt="Alumni" class="w-full h-[28rem] object-cover"></div>
                            <div class="swiper-slide"><img src="assets/images/Events/cls1.jpg" alt="Alumni" class="w-full h-[28rem] object-cover"></div>
                            <div class="swiper-slide"><img src="assets/images/Events/cls2.jpg" alt="Alumni" class="w-full h-[28rem] object-cover"></div>
                ...
                <div class="rounded-[2rem] bg-white p-6 md:p-8 shadow-xl shadow-purple-100/50 ring-1 ring-purple-100">
                    <h2 class="text-3xl font-bold text-purple-800 mb-6">Chapel Moments</h2>
                    <div class="swiper chapel-swiper rounded-[1.5rem] overflow-hidden shadow-lg">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="assets/images/Chapel/chap3.jpg" alt="Service 1" class="w-full h-[28rem] object-cover"></div>
                            <div class="swiper-slide"><img src="assets/images/Chapel/chap1.jpg" alt="Service 2" class="w-full h-[28rem] object-cover"></div>
                            <div class="swiper-slide"><img src="assets/images/Chapel/chap4.jpg" alt="Service 3" class="w-full h-[28rem] object-cover"></div>
    ...
    <!-- Testimonials Section -->
    <section id="testimonials" class="py-20 md:py-24">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-purple-800">💬 What Our Students Say</h2>
                <p class="mt-2 text-gray-600 text-lg">Real voices, real journeys, transformed lives.</p>
            ...
            <div class="swiper testimonials-swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="rounded-[1.75rem] bg-white shadow-xl shadow-purple-100/50 ring-1 ring-purple-100 p-8 text-center transition-all duration-300 transform hover:-translate-y-2">
                            <img src="assets/img/testimonials/nicole.jpeg" alt="Nicole" class="w-24 h-24 mx-auto rounded-full object-cover mb-4">
                            <h3 class="text-lg font-bold text-gray-800">Nicole</h3>
                            <p class="text-sm text-gray-500 mb-4">Texas, USA</p>
                            <div class="text-yellow-400 text-sm mb-4">★★★★★</div>
