...
<?php else: ?>
  ...
  <form id="regForm"
    ...
    <fieldset class="border border-gray-300 p-4 rounded">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <input type="text" name="gname" placeholder="Guardian's Full Name" required class="px-4 py-2 border rounded w-full" />
        <input type="text" name="grelation" placeholder="Relationship (e.g., Father, Aunt)" required class="px-4 py-2 border rounded w-full" />
        <input type="text" name="gcontact" placeholder="Guardian's Contact Phone" required class="px-4 py-2 border rounded w-full" />
      </div>
    </fieldset>
    ...
    <fieldset class="border border-gray-300 p-4 rounded">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div id="spouseGroup" class="grid grid-cols-1 md:grid-cols-2 gap-4 md:col-span-2 hidden">
          <input type="text" name="sname" id="sname" placeholder="Spouse Name" class="px-4 py-2 border rounded w-full" />
          <input type="text" name="scont" id="scont" placeholder="Spouse Contact" class="px-4 py-2 border rounded w-full" />
        </div>
      </div>
    </fieldset>
    ...
    <fieldset class="border border-gray-300 p-4 rounded">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="file" name="passport" accept=".jpg,.jpeg,.png,.pdf" required class="w-full px-4 py-2 border rounded" />
        </div>

        <div>
          <label class="block mb-1">Proof of Hostel Fee Payment</label>
          <input type="file" name="fees" accept=".jpg,.jpeg,.png,.pdf" required class="w-full px-4 py-2 border rounded" />
        </div>
