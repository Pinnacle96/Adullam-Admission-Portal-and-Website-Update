...
<body class="bg-gray-100 min-h-screen">
    <main class="max-w-5xl mx-auto p-6 bg-white shadow rounded mt-10">
        ...
        <form id="regForm" action="hostel_submit" method="POST" enctype="multipart/form-data" class="space-y-6">

            <!-- Hidden field to track form source -->
            <input type="hidden" name="form_source" value="external" />
            ...
            <fieldset class="border border-gray-300 p-4 rounded">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="allergy" placeholder="Allergies / Illness / Disability" required
                        class="px-4 py-2 border rounded w-full" />

                    <label class="block w-full">
                        <span class="text-sm text-gray-600">Date of Birth</span>
                        <input type="date" name="dob" id="dob" class="px-4 py-2 border rounded w-full mt-1" required />
                    </label>

                    <label class="block w-full">
                        <span class="text-sm text-gray-600">Age</span>
                        <input type="text" name="age" id="age" readonly
                            class="bg-gray-100 px-4 py-2 border rounded w-full mt-1" placeholder="Age" />
                    </label>
                    ...
                    <input type="text" name="state_origin" id="stateOrigin" placeholder="State of Origin" required
                        class="px-4 py-2 border rounded w-full" />
                </div>
            </fieldset>
            ...
            <fieldset class="border border-gray-300 p-4 rounded">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" name="res_address" id="res_address" placeholder="Residential Address" required
                        class="px-4 py-2 border rounded w-full" />
                    <input type="text" name="res_city" id="res_city" placeholder="Residential City" required
                        class="px-4 py-2 border rounded w-full" />
                    <input type="text" name="res_state" id="res_state" placeholder="Residential State" required
                        class="px-4 py-2 border rounded w-full" />
                    <input type="text" name="res_country" id="res_country" placeholder="Residential Country" required
                        class="px-4 py-2 border rounded w-full" />
                    ...
                    <input type="text" name="perm_address" id="perm_address" placeholder="Permanent Address" required
                        class="px-4 py-2 border rounded w-full" />
                    <input type="text" name="perm_city" id="perm_city" placeholder="Permanent City" required
                        class="px-4 py-2 border rounded w-full" />
                    <input type="text" name="perm_state" id="perm_state" placeholder="Permanent State" required
                        class="px-4 py-2 border rounded w-full" />
                    <input type="text" name="perm_country" id="perm_country" placeholder="Permanent Country" required
                        class="px-4 py-2 border rounded w-full" />
                </div>
            </fieldset>
            ...
            <fieldset class="border border-gray-300 p-4 rounded">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <label class="block w-full">
                        ...
                        <input type="date" name="payment_date" required class="px-4 py-2 border rounded w-full mt-1" />
                    </label>
                </div>
            </fieldset>
    ...
    <script>
    const remaining = <?=json_encode($remaining, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT)?>;
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        marital.addEventListener('change', toggleS);
        toggleS();
