...
<body class="min-h-screen flex items-center justify-center px-4 py-8">
    <div class="bg-white rounded-xl shadow-sm w-full max-w-md overflow-hidden border border-gray-100">
        ...
        <form id="form-register" class="p-6 space-y-5">
            ...
            <p class="text-sm text-center text-gray-600">
                    ...
                    <a href="applicant_login" class="font-medium text-purple-600 hover:text-purple-500">Sign in here</a>
                </p>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Your existing JavaScript code for form submission handling
            function handleFormSubmit(form, endpoint, successMessage) {
                return async function(e) {
                    ...
                    try {
                        ...
                        // Check if reCAPTCHA response exists before submitting
                        ...
                        // Reset reCAPTCHA and form state
                        grecaptcha.reset();
