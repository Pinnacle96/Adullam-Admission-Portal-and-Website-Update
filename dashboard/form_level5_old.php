...
<div style='font-family:Segoe UI,Roboto,Helvetica,Arial,sans-serif;max-width:600px;margin:auto;padding:20px;background-color:#f9fafb;border-radius:8px;border:1px solid #eee;'>
  ...
  <div style='text-align:center;margin:30px 0;'>
    <a href='https://adullam.ng/dashboard/recommend?token=$token'
  ...
  <p style='font-size:14px;color:#555;line-height:1.5;'>
    ...
    <a href='https://adullam.ng/dashboard/recommend?token=$token' style='color:#6B21A8;word-break:break-all;'>
      https://adullam.ng/dashboard/recommend?token=$token
    </a>
  </p>
...
";
    ...
    if (isset($_POST['continue'])) {
        ...
        echo "<script>window.location.href = 'form_level6';</script>";
